 ...
 * 
 * @class MediaWikiAPI
 * @param {String} [url] MediaWiki web API url (defaults to Estonian Wikipeedia)
 * @constructor
 */
var MediaWikiAPI = function(url) {
  ...
  this.openSearch = function(query_str, params) {
    ...
    qxhrPromise.then(function done(data) {
  ...
  this.query = function(query_str, params) {
    ...
    // päring tehakse lubadusega, kui lubadus täitub, siis tehakse .then
